...
export const LiquidGlassButton = ({
  ...
  <GlassEffect
    href={href}
    target={target}
    className={`rounded-3xl px-10 py-6 ${animated ? "hover:rounded-4xl hover:px-11 hover:py-7 transition-all duration-700" : ""} ${className}`}
  >
    <div
      className={animated ? "transition-all duration-700 hover:scale-95" : ""}
      style={
        animated
          ? {
